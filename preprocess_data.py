...
df = pd.read_csv("data_sets/Sudden Cardiac Death Holter Database.csv", low_memory=False)
...
np.save("preprocessed_datasets/X.npy", X)
np.save("preprocessed_datasets/y.npy", y)
